...
def main():
    ...
    print(json.dumps({"articleTitle": article_title, "wordCount": data["wordCount"], "faq": len(data["faq"]), "bodyTables": body_html.count("<table>"), "bodyLinks": body_html.count("<a href=")}, ensure_ascii=False))
