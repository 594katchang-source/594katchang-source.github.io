...
plan_content = """# Kat Chang 凱特營養師｜三大業務支柱關鍵字佈局深度規劃指南 (Master Keyword Strategy Plan)
...
```mermaid
graph TD
    Kat[核心實體：張雁雲博士 / 凱特營養師 Kat Chang] --> Pillar1[支柱一：專業營養師<br>Clinical & Geriatric Dietitian]
    Kat --> Pillar2[支柱二：專業講師<br>Corporate & Public Health Lecturer]
    Kat --> Pillar3[支柱三：健康與法規顧問<br>Health, Regulatory & EdTech Consultant]

    Pillar1 --> Audience1[長輩子女 / 慢病族群 / 亞健康上班族]
    Pillar2 --> Audience2[企業 HR / 職護 / 福委會 / 長照機構 / 樂齡大學]
    Pillar3 --> Audience3[生技品牌 / 食品廠商 / 研發團隊 / 衛教採購]

    Pillar1 --> LP1[著陸頁：about.html / 首頁 / 部落格深度專題]
    Pillar2 --> LP2[著陸頁：class.html / teach/ 互動教具專區]
    Pillar3 --> LP3[著陸頁：首頁顧問專區 / teach/paper-radar/ 論文小站]

    LP1 --> Funnel1[轉換行動：LINE 諮詢 / Zcal 預約一對一評估]
    LP2 --> Funnel2[轉換行動：講座邀約表單 / EAP 方案特約合作]
    LP3 --> Funnel3[轉換行動：法規顧問諮詢 / 專案研發合約洽談]
```
...
output_file = os.path.join(r"d:\@Codex\594katchang-source.github.io-main", "work", "2026-09-01-three-pillars-keyword-strategy", "output", "Three_Pillars_Keyword_Strategy_Master_Plan.md")
with open(output_file, "w", encoding="utf-8") as f:
    f.write(plan_content)

print(f"Master plan written successfully to: {output_file}")
